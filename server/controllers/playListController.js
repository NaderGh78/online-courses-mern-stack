    ...
    async (req, res) => {
        ...
        if (req.file) {
            ...
            try {
                ...
                fs.unlinkSync(req.file.path); // Ensure the file is deleted 
...
const getSinglePlaylistCtrl = asyncHandler(
    ...
    async (req, res) => {
        ...
        const playlist = await PlaylistModel.findById(req.params.id).populate("teacher", "username profilePhoto");
...
const deletePlaylistCtrl = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const courseIds = playlist.courses;
        //remove the course and comment tht belong to the course whe remove the playlist
        ...
        console.log("Error in deletePlaylistCtrl:", error.message);

        res.status(500).json({ message: "Something went wrong while deleting the playlist.", error: error.message });
...
const searchPlaylistCtrl = asyncHandler(async (req, res) => {
